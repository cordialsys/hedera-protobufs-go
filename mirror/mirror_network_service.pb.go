...
func (x *AddressBookQuery) GetFileId() *common.FileID {
	if x != nil {
		return x.FileId
	}
	return nil
...
const file_mirror_mirror_network_service_proto_rawDesc = "" +
	"\n" +
	"#mirror/mirror_network_service.proto\x12\x1bcom.hedera.mirror.api.proto\x1a\x11basic_types.proto\x1a\x0ftimestamp.proto\"P\n" +
...
var (
	...
	file_mirror_mirror_network_service_proto_rawDescData []byte
)
...
func file_mirror_mirror_network_service_proto_rawDescGZIP() []byte {
	file_mirror_mirror_network_service_proto_rawDescOnce.Do(func() {
		file_mirror_mirror_network_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mirror_mirror_network_service_proto_rawDesc), len(file_mirror_mirror_network_service_proto_rawDesc)))
	})
...
func file_mirror_mirror_network_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mirror_mirror_network_service_proto_rawDesc), len(file_mirror_mirror_network_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
