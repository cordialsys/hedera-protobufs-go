...
type ConsensusTopicQuery struct {
	...
	// not set.
	ConsensusStartTime *common.Timestamp `protobuf:"bytes,2,opt,name=consensusStartTime,proto3" json:"consensusStartTime,omitempty"`
	// *
	// Include messages which reached consensus before this time. If not set it will receive
	// indefinitely.
	ConsensusEndTime *common.Timestamp `protobuf:"bytes,3,opt,name=consensusEndTime,proto3" json:"consensusEndTime,omitempty"`
	// *
...
func (x *ConsensusTopicQuery) GetTopicID() *common.TopicID {
	if x != nil {
		return x.TopicID
	}
	return nil
...
func (x *ConsensusTopicQuery) GetConsensusStartTime() *common.Timestamp {
	if x != nil {
...
func (x *ConsensusTopicQuery) GetConsensusEndTime() *common.Timestamp {
	if x != nil {
...
func (x *ConsensusTopicResponse) GetConsensusTimestamp() *common.Timestamp {
	if x != nil {
...
var file_mirror_consensus_service_proto_goTypes = []any{
	...
	(*common.TopicID)(nil),                     // 2: proto.TopicID
