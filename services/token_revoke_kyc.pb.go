...
func (x *TokenRevokeKycTransactionBody) GetToken() *common.TokenID {
	if x != nil {
		return x.Token
	}
	return nil
...
func (x *TokenRevokeKycTransactionBody) GetAccount() *common.AccountID {
	if x != nil {
		return x.Account
	}
	return nil
...
const file_token_revoke_kyc_proto_rawDesc = "" +
	"\n" +
	"\x16token_revoke_kyc.proto\x12\x05proto\x1a\x11basic_types.proto\"q\n" +
	"\x1dTokenRevokeKycTransactionBody\x12$\n" +
...
var (
	...
	file_token_revoke_kyc_proto_rawDescData []byte
)

func file_token_revoke_kyc_proto_rawDescGZIP() []byte {
	file_token_revoke_kyc_proto_rawDescOnce.Do(func() {
		file_token_revoke_kyc_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_token_revoke_kyc_proto_rawDesc), len(file_token_revoke_kyc_proto_rawDesc)))
	})
...
func file_token_revoke_kyc_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_token_revoke_kyc_proto_rawDesc), len(file_token_revoke_kyc_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
