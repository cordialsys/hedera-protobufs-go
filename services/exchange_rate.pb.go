...
func (x *ExchangeRate) GetExpirationTime() *common.TimestampSeconds {
	if x != nil {
...
const file_exchange_rate_proto_rawDesc = "" +
	...
	"\bnextRate\x18\x02 \x01(\v2\x13.proto.ExchangeRateR\bnextRateBZ\n" +
...
var file_exchange_rate_proto_goTypes = []any{
	...
	(*common.TimestampSeconds)(nil), // 2: proto.TimestampSeconds
}
