...
type CryptoDeleteTransactionBody struct {
	...
	TransferAccountID *common.AccountID `protobuf:"bytes,1,opt,name=transferAccountID,proto3" json:"transferAccountID,omitempty"`
	// *
	// An account identifier.
	// <p>
	...
	DeleteAccountID *common.AccountID `protobuf:"bytes,2,opt,name=deleteAccountID,proto3" json:"deleteAccountID,omitempty"`
...
func (x *CryptoDeleteTransactionBody) GetTransferAccountID() *common.AccountID {
	if x != nil {
...
func (x *CryptoDeleteTransactionBody) GetDeleteAccountID() *common.AccountID {
	if x != nil {
...
const file_crypto_delete_proto_rawDesc = "" +
	...
	"\x0fdeleteAccountID\x18\x02 \x01(\v2\x10.proto.AccountIDR\x0fdeleteAccountIDBY\n" +
