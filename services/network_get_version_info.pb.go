...
type NetworkGetVersionInfoResponse struct {
	...
	HapiProtoVersion *common.SemanticVersion `protobuf:"bytes,2,opt,name=hapiProtoVersion,proto3" json:"hapiProtoVersion,omitempty"`
	// *
	// A Services version.
	// <p>
	// This SHALL be the current version of the Hedera Services software
	// operating the network.
	HederaServicesVersion *common.SemanticVersion `protobuf:"bytes,3,opt,name=hederaServicesVersion,proto3" json:"hederaServicesVersion,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *NetworkGetVersionInfoResponse) GetHapiProtoVersion() *common.SemanticVersion {
	if x != nil {
...
func (x *NetworkGetVersionInfoResponse) GetHederaServicesVersion() *common.SemanticVersion {
	if x != nil {
