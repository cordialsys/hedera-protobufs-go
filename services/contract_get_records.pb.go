...
func (x *ContractGetRecordsQuery) GetContractID() *common.ContractID {
	if x != nil {
		return x.ContractID
	}
	return nil
...
func (x *ContractGetRecordsResponse) GetContractID() *common.ContractID {
	if x != nil {
		return x.ContractID
	}
	return nil
...
const file_contract_get_records_proto_rawDesc = "" +
	...
	"contractID\x18\x02 \x01(\v2\x11.proto.ContractIDR\n" +
	"contractID\x122\n" +
	"\arecords\x18\x03 \x03(\v2\x18.proto.TransactionRecordR\arecords:\x02\x18\x01BY\n" +
