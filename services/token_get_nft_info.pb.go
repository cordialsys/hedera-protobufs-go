...
type TokenGetNftInfoQuery struct {
	...
	// *
	// The ID of the NFT
	NftID         *common.NftID `protobuf:"bytes,2,opt,name=nftID,proto3" json:"nftID,omitempty"`
...
func (x *TokenGetNftInfoQuery) GetNftID() *common.NftID {
	if x != nil {
		return x.NftID
	}
	return nil
...
type TokenNftInfo struct {
	...
	// *
	// The ID of the NFT
	NftID *common.NftID `protobuf:"bytes,1,opt,name=nftID,proto3" json:"nftID,omitempty"`
	// *
	// The current owner of the NFT
	AccountID *common.AccountID `protobuf:"bytes,2,opt,name=accountID,proto3" json:"accountID,omitempty"`
	// *
	// The effective consensus timestamp at which the NFT was minted
	CreationTime *common.Timestamp `protobuf:"bytes,3,opt,name=creationTime,proto3" json:"creationTime,omitempty"`
	// *
	...
	SpenderId     *common.AccountID `protobuf:"bytes,6,opt,name=spender_id,json=spenderId,proto3" json:"spender_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TokenNftInfo) GetNftID() *common.NftID {
	if x != nil {
		return x.NftID
	}
	return nil
...
func (x *TokenNftInfo) GetAccountID() *common.AccountID {
	if x != nil {
		return x.AccountID
	}
	return nil
...
func (x *TokenNftInfo) GetCreationTime() *common.Timestamp {
	if x != nil {
...
func (x *TokenNftInfo) GetSpenderId() *common.AccountID {
	if x != nil {
		return x.SpenderId
	}
	return nil
...
var file_token_get_nft_info_proto_goTypes = []any{
	...
	(*common.NftID)(nil),            // 4: proto.NftID
