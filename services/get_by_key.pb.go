...
type GetByKeyQuery struct {
	...
	Key           *common.Key `protobuf:"bytes,2,opt,name=key,proto3" json:"key,omitempty"`
...
func (x *GetByKeyQuery) GetKey() *common.Key {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *EntityID) GetAccountID() *common.AccountID {
	if x != nil {
...
func (x *EntityID) GetFileID() *common.FileID {
	if x != nil {
...
func (x *EntityID) GetContractID() *common.ContractID {
	if x != nil {
...
type EntityID_AccountID struct {
	...
	AccountID *common.AccountID `protobuf:"bytes,1,opt,name=accountID,proto3,oneof"`
}
...
type EntityID_FileID struct {
	...
	FileID *common.FileID `protobuf:"bytes,3,opt,name=fileID,proto3,oneof"`
}

type EntityID_ContractID struct {
	// *
	// The smart contract ID that identifies instance
	ContractID *common.ContractID `protobuf:"bytes,4,opt,name=contractID,proto3,oneof"`
}
...
const file_get_by_key_proto_rawDesc = "" +
	"\n" +
	"\x10get_by_key.proto\x12\x05proto\x1a\x11basic_types.proto\x1a\x12query_header.proto\x1a\x15response_header.proto\x1a\x1acrypto_add_live_hash.proto\"Y\n" +
	"\rGetByKeyQuery\x12*\n" +
	"\x06header\x18\x01 \x01(\v2\x12.proto.QueryHeaderR\x06header\x12\x1c\n" +
	"\x03key\x18\x02 \x01(\v2\n" +
	".proto.KeyR\x03key\"\xd3\x01\n" +
	"\bEntityID\x120\n" +
	...
	"\bentities\x18\x02 \x03(\v2\x0f.proto.EntityIDR\bentitiesBZ\n" +
...
var file_get_by_key_proto_goTypes = []any{
	...
	(*common.FileID)(nil),     // 7: proto.FileID
	(*common.ContractID)(nil), // 8: proto.ContractID
