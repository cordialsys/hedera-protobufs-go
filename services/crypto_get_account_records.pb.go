...
func (x *CryptoGetAccountRecordsQuery) GetAccountID() *common.AccountID {
	if x != nil {
		return x.AccountID
	}
	return nil
...
func (x *CryptoGetAccountRecordsResponse) GetAccountID() *common.AccountID {
	if x != nil {
		return x.AccountID
	}
	return nil
...
const file_crypto_get_account_records_proto_rawDesc = "" +
	...
	"\arecords\x18\x03 \x03(\v2\x18.proto.TransactionRecordR\arecordsBZ\n" +
