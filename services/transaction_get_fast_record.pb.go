...
func (x *TransactionGetFastRecordQuery) GetTransactionID() *common.TransactionID {
	if x != nil {
...
const file_transaction_get_fast_record_proto_rawDesc = "" +
	"\n" +
	"!transaction_get_fast_record.proto\x12\x05proto\x1a\x18transaction_record.proto\x1a\x11basic_types.proto\x1a\x12query_header.proto\x1a\x15response_header.proto\"\x87\x01\n" +
	"\x1dTransactionGetFastRecordQuery\x12*\n" +
	"\x06header\x18\x01 \x01(\v2\x12.proto.QueryHeaderR\x06header\x12:\n" +
	"\rtransactionID\x18\x02 \x01(\v2\x14.proto.TransactionIDR\rtransactionID\"\x99\x01\n" +
	" TransactionGetFastRecordResponse\x12-\n" +
	"\x06header\x18\x01 \x01(\v2\x15.proto.ResponseHeaderR\x06header\x12F\n" +
	"\x11transactionRecord\x18\x02 \x01(\v2\x18.proto.TransactionRecordR\x11transactionRecordBZ\n" +
...
var (
	...
	file_transaction_get_fast_record_proto_rawDescData []byte
)

func file_transaction_get_fast_record_proto_rawDescGZIP() []byte {
	file_transaction_get_fast_record_proto_rawDescOnce.Do(func() {
		file_transaction_get_fast_record_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_transaction_get_fast_record_proto_rawDesc), len(file_transaction_get_fast_record_proto_rawDesc)))
	})
...
func file_transaction_get_fast_record_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_transaction_get_fast_record_proto_rawDesc), len(file_transaction_get_fast_record_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
