...
type FixedCustomFee struct {
	...
	FeeCollectorAccountId *common.AccountID `protobuf:"bytes,2,opt,name=fee_collector_account_id,json=feeCollectorAccountId,proto3" json:"fee_collector_account_id,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *FixedCustomFee) GetFeeCollectorAccountId() *common.AccountID {
	if x != nil {
		return x.FeeCollectorAccountId
	}
	return nil
...
type FeeExemptKeyList struct {
	...
	Keys          []*common.Key `protobuf:"bytes,1,rep,name=keys,proto3" json:"keys,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *FeeExemptKeyList) GetKeys() []*common.Key {
	if x != nil {
		return x.Keys
	}
	return nil
...
func (x *CustomFeeLimit) GetAccountId() *common.AccountID {
	if x != nil {
		return x.AccountId
	}
	return nil
...
var file_custom_fees_proto_goTypes = []any{
	...
	(*common.Fraction)(nil),    // 9: proto.Fraction
	(*common.TokenID)(nil),     // 10: proto.TokenID
	(*common.AccountID)(nil),   // 11: proto.AccountID
	(*common.Key)(nil),         // 12: proto.Key
}
