...
func (x *CryptoGetStakersQuery) GetAccountID() *common.AccountID {
	if x != nil {
		return x.AccountID
	}
	return nil
...
func (x *ProxyStaker) GetAccountID() *common.AccountID {
	if x != nil {
		return x.AccountID
	}
	return nil
...
func (x *AllProxyStakers) GetAccountID() *common.AccountID {
	if x != nil {
		return x.AccountID
	}
	return nil
...
const file_crypto_get_stakers_proto_rawDesc = "" +
	"\n" +
	"\x18crypto_get_stakers.proto\x12\x05proto\x1a\x11basic_types.proto\x1a\x12query_header.proto\x1a\x15response_header.proto\"s\n" +
	"\x15CryptoGetStakersQuery\x12*\n" +
	"\x06header\x18\x01 \x01(\v2\x12.proto.QueryHeaderR\x06header\x12.\n" +
	"\taccountID\x18\x02 \x01(\v2\x10.proto.AccountIDR\taccountID\"U\n" +
	"\vProxyStaker\x12.\n" +
	...
	"\vproxyStaker\x18\x02 \x03(\v2\x12.proto.ProxyStakerR\vproxyStaker\"{\n" +
	"\x18CryptoGetStakersResponse\x12-\n" +
	"\x06header\x18\x01 \x01(\v2\x15.proto.ResponseHeaderR\x06header\x120\n" +
	"\astakers\x18\x03 \x01(\v2\x16.proto.AllProxyStakersR\astakersBZ\n" +
