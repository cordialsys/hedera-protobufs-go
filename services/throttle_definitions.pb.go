...
type ThrottleGroup struct {
	...
	Operations []common.HederaFunctionality `protobuf:"varint,1,rep,packed,name=operations,proto3,enum=proto.HederaFunctionality" json:"operations,omitempty"`
	// *
...
func (x *ThrottleGroup) GetOperations() []common.HederaFunctionality {
	if x != nil {
		return x.Operations
	}
	return nil
...
var file_throttle_definitions_proto_goTypes = []any{
	...
	(common.HederaFunctionality)(0), // 3: proto.HederaFunctionality
}
