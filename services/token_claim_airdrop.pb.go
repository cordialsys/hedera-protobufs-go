...
func (x *TokenClaimAirdropTransactionBody) GetPendingAirdrops() []*common.PendingAirdropId {
	if x != nil {
...
const file_token_claim_airdrop_proto_rawDesc = "" +
	"\n" +
	"\x19token_claim_airdrop.proto\x12\x05proto\x1a\x11basic_types.proto\"f\n" +
	" TokenClaimAirdropTransactionBody\x12B\n" +
...
var (
	...
	file_token_claim_airdrop_proto_rawDescData []byte
)

func file_token_claim_airdrop_proto_rawDescGZIP() []byte {
	file_token_claim_airdrop_proto_rawDescOnce.Do(func() {
		file_token_claim_airdrop_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_token_claim_airdrop_proto_rawDesc), len(file_token_claim_airdrop_proto_rawDesc)))
	})
...
func file_token_claim_airdrop_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_token_claim_airdrop_proto_rawDesc), len(file_token_claim_airdrop_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
