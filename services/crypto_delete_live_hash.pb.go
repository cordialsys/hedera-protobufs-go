...
type CryptoDeleteLiveHashTransactionBody struct {
	...
	AccountOfLiveHash *common.AccountID `protobuf:"bytes,1,opt,name=accountOfLiveHash,proto3" json:"accountOfLiveHash,omitempty"`
	// *
...
func (x *CryptoDeleteLiveHashTransactionBody) GetAccountOfLiveHash() *common.AccountID {
	if x != nil {
