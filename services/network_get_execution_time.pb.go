...
const file_network_get_execution_time_proto_rawDesc = "" +
	"\n" +
	" network_get_execution_time.proto\x12\x05proto\x1a\x11basic_types.proto\x1a\x12query_header.proto\x1a\x15response_header.proto\"\x8d\x01\n" +
	"\x1cNetworkGetExecutionTimeQuery\x12*\n" +
	"\x06header\x18\x01 \x01(\v2\x12.proto.QueryHeaderR\x06header\x12=\n" +
	"\x0ftransaction_ids\x18\x02 \x03(\v2\x14.proto.TransactionIDR\x0etransactionIds:\x02\x18\x01\"}\n" +
	"\x1fNetworkGetExecutionTimeResponse\x12-\n" +
	"\x06header\x18\x01 \x01(\v2\x15.proto.ResponseHeaderR\x06header\x12'\n" +
	"\x0fexecution_times\x18\x02 \x03(\x04R\x0eexecutionTimes:\x02\x18\x01BY\n" +
