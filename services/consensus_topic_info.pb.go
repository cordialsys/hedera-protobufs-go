...
type ConsensusTopicInfo struct {
	...
	FeeExemptKeyList []*common.Key `protobuf:"bytes,11,rep,name=fee_exempt_key_list,json=feeExemptKeyList,proto3" json:"fee_exempt_key_list,omitempty"`
	// *
...
func (x *ConsensusTopicInfo) GetFeeScheduleKey() *common.Key {
	if x != nil {
...
func (x *ConsensusTopicInfo) GetFeeExemptKeyList() []*common.Key {
	if x != nil {
...
const file_consensus_topic_info_proto_rawDesc = "" +
	"\n" +
	"\x1aconsensus_topic_info.proto\x12\x05proto\x1a\x11basic_types.proto\x1a\x11custom_fees.proto\x1a\x0eduration.proto\x1a\x0ftimestamp.proto\"\xbd\x04\n" +
	...
	"\tledger_id\x18\t \x01(\fR\bledgerId\x124\n" +
