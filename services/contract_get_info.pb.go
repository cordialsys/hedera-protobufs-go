...
func (x *ContractGetInfoQuery) GetContractID() *common.ContractID {
	if x != nil {
		return x.ContractID
	}
	return nil
...
type ContractGetInfoResponse_ContractInfo struct {
	...
	AdminKey *common.Key `protobuf:"bytes,4,opt,name=adminKey,proto3" json:"adminKey,omitempty"`
	// *
	// The point in time at which this contract will expire.
	ExpirationTime *common.Timestamp `protobuf:"bytes,5,opt,name=expirationTime,proto3" json:"expirationTime,omitempty"`
	// *
	...
	TokenRelationships []*common.TokenRelationship `protobuf:"bytes,11,rep,name=tokenRelationships,proto3" json:"tokenRelationships,omitempty"`
	// *
	...
	AutoRenewAccountId *common.AccountID `protobuf:"bytes,13,opt,name=auto_renew_account_id,json=autoRenewAccountId,proto3" json:"auto_renew_account_id,omitempty"`
	// *
	...
	StakingInfo   *common.StakingInfo `protobuf:"bytes,15,opt,name=staking_info,json=stakingInfo,proto3" json:"staking_info,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ContractGetInfoResponse_ContractInfo) GetContractID() *common.ContractID {
	if x != nil {
		return x.ContractID
	}
	return nil
...
func (x *ContractGetInfoResponse_ContractInfo) GetAccountID() *common.AccountID {
	if x != nil {
		return x.AccountID
	}
	return nil
...
func (x *ContractGetInfoResponse_ContractInfo) GetAdminKey() *common.Key {
	if x != nil {
		return x.AdminKey
	}
	return nil
...
func (x *ContractGetInfoResponse_ContractInfo) GetExpirationTime() *common.Timestamp {
	if x != nil {
...
// Deprecated: Marked as deprecated in contract_get_info.proto.
func (x *ContractGetInfoResponse_ContractInfo) GetTokenRelationships() []*common.TokenRelationship {
	if x != nil {
...
func (x *ContractGetInfoResponse_ContractInfo) GetAutoRenewAccountId() *common.AccountID {
	if x != nil {
...
func (x *ContractGetInfoResponse_ContractInfo) GetStakingInfo() *common.StakingInfo {
	if x != nil {
