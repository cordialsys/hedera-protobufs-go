...
func (x *NodeUpdateTransactionBody) GetAccountId() *common.AccountID {
	if x != nil {
		return x.AccountId
	}
	return nil
...
func (x *NodeUpdateTransactionBody) GetGossipEndpoint() []*common.ServiceEndpoint {
	if x != nil {
...
func (x *NodeUpdateTransactionBody) GetServiceEndpoint() []*common.ServiceEndpoint {
	if x != nil {
...
func (x *NodeUpdateTransactionBody) GetAdminKey() *common.Key {
	if x != nil {
		return x.AdminKey
	}
	return nil
...
const file_node_update_proto_rawDesc = "" +
	...
	" \x01(\v2\x16.proto.ServiceEndpointR\x11grpcProxyEndpointBY\n" +
