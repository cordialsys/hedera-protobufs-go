...
type ConsensusUpdateTopicTransactionBody struct {
	...
	// update.<br/>
	FeeScheduleKey *common.Key `protobuf:"bytes,10,opt,name=fee_schedule_key,json=feeScheduleKey,proto3" json:"fee_schedule_key,omitempty"`
	// *
	// A set of keys<br/>
...
func (x *ConsensusUpdateTopicTransactionBody) GetFeeScheduleKey() *common.Key {
	if x != nil {
...
const file_consensus_update_topic_proto_rawDesc = "" +
	"\n" +
	"\x1cconsensus_update_topic.proto\x12\x05proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x11basic_types.proto\x1a\x11custom_fees.proto\x1a\x0eduration.proto\x1a\x0ftimestamp.proto\"\xc0\x04\n" +
	...
	"\x10autoRenewAccount\x18\t \x01(\v2\x10.proto.AccountIDR\x10autoRenewAccount\x124\n" +
	"\x10fee_schedule_key\x18\n" +
	" \x01(\v2\n" +
	".proto.KeyR\x0efeeScheduleKey\x12F\n" +
	"\x13fee_exempt_key_list\x18\v \x01(\v2\x17.proto.FeeExemptKeyListR\x10feeExemptKeyList\x12:\n" +
	"\vcustom_fees\x18\f \x01(\v2\x19.proto.FixedCustomFeeListR\n" +
	"customFeesBZ\n" +
