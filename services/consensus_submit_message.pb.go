...
type ConsensusMessageChunkInfo struct {
	...
	InitialTransactionID *common.TransactionID `protobuf:"bytes,1,opt,name=initialTransactionID,proto3" json:"initialTransactionID,omitempty"`
	// *
...
func (x *ConsensusMessageChunkInfo) GetInitialTransactionID() *common.TransactionID {
	if x != nil {
...
func (x *ConsensusSubmitMessageTransactionBody) GetTopicID() *common.TopicID {
	if x != nil {
		return x.TopicID
	}
	return nil
...
var file_consensus_submit_message_proto_goTypes = []any{
	...
	(*common.TransactionID)(nil),                  // 2: proto.TransactionID
