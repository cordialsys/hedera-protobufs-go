...
func (x *TssMessageTransactionBody) Reset() {
	*x = TssMessageTransactionBody{}
	mi := &file_auxiliary_tss_tss_message_proto_msgTypes[0]
...
func (*TssMessageTransactionBody) Descriptor() ([]byte, []int) {
	return file_auxiliary_tss_tss_message_proto_rawDescGZIP(), []int{0}
}
...
var File_auxiliary_tss_tss_message_proto protoreflect.FileDescriptor

const file_auxiliary_tss_tss_message_proto_rawDesc = "" +
	"\n" +
	"\x1fauxiliary/tss/tss_message.proto\x12&com.hedera.hapi.services.auxiliary.tss\"\xb9\x01\n" +
...
var (
	...
	file_auxiliary_tss_tss_message_proto_rawDescData []byte
)

func file_auxiliary_tss_tss_message_proto_rawDescGZIP() []byte {
	file_auxiliary_tss_tss_message_proto_rawDescOnce.Do(func() {
		file_auxiliary_tss_tss_message_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_auxiliary_tss_tss_message_proto_rawDesc), len(file_auxiliary_tss_tss_message_proto_rawDesc)))
	})
	return file_auxiliary_tss_tss_message_proto_rawDescData
}

var file_auxiliary_tss_tss_message_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_auxiliary_tss_tss_message_proto_goTypes = []any{
	(*TssMessageTransactionBody)(nil), // 0: com.hedera.hapi.services.auxiliary.tss.TssMessageTransactionBody
}
var file_auxiliary_tss_tss_message_proto_depIdxs = []int32{
...
func init() { file_auxiliary_tss_tss_message_proto_init() }
func file_auxiliary_tss_tss_message_proto_init() {
	if File_auxiliary_tss_tss_message_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_auxiliary_tss_tss_message_proto_rawDesc), len(file_auxiliary_tss_tss_message_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_auxiliary_tss_tss_message_proto_goTypes,
		DependencyIndexes: file_auxiliary_tss_tss_message_proto_depIdxs,
		MessageInfos:      file_auxiliary_tss_tss_message_proto_msgTypes,
	}.Build()
	File_auxiliary_tss_tss_message_proto = out.File
	file_auxiliary_tss_tss_message_proto_goTypes = nil
	file_auxiliary_tss_tss_message_proto_depIdxs = nil
}
