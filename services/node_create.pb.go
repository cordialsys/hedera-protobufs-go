...
type NodeCreateTransactionBody struct {
	...
	GossipEndpoint []*common.ServiceEndpoint `protobuf:"bytes,3,rep,name=gossip_endpoint,json=gossipEndpoint,proto3" json:"gossip_endpoint,omitempty"`
	// *
	...
	ServiceEndpoint []*common.ServiceEndpoint `protobuf:"bytes,4,rep,name=service_endpoint,json=serviceEndpoint,proto3" json:"service_endpoint,omitempty"`
	// *
...
func (x *NodeCreateTransactionBody) GetAccountId() *common.AccountID {
	if x != nil {
		return x.AccountId
	}
	return nil
...
func (x *NodeCreateTransactionBody) GetGossipEndpoint() []*common.ServiceEndpoint {
	if x != nil {
...
func (x *NodeCreateTransactionBody) GetServiceEndpoint() []*common.ServiceEndpoint {
	if x != nil {
...
func (x *NodeCreateTransactionBody) GetAdminKey() *common.Key {
	if x != nil {
		return x.AdminKey
	}
	return nil
...
const file_node_create_proto_rawDesc = "" +
	...
	"\x13grpc_proxy_endpoint\x18\t \x01(\v2\x16.proto.ServiceEndpointR\x11grpcProxyEndpointBY\n" +
