...
type SignedTransaction struct {
	...
	SigMap        *common.SignatureMap `protobuf:"bytes,2,opt,name=sigMap,proto3" json:"sigMap,omitempty"`
...
func (x *SignedTransaction) GetSigMap() *common.SignatureMap {
	if x != nil {
		return x.SigMap
	}
	return nil
...
var (
	...
	file_transaction_contents_proto_rawDescData []byte
)

func file_transaction_contents_proto_rawDescGZIP() []byte {
	file_transaction_contents_proto_rawDescOnce.Do(func() {
		file_transaction_contents_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_transaction_contents_proto_rawDesc), len(file_transaction_contents_proto_rawDesc)))
	})
...
var file_transaction_contents_proto_goTypes = []any{
	...
	(*common.SignatureMap)(nil), // 1: proto.SignatureMap
}
...
func file_transaction_contents_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_transaction_contents_proto_rawDesc), len(file_transaction_contents_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
