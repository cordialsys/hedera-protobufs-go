...
type TokenAirdropTransactionBody struct {
	...
	TokenTransfers []*common.TokenTransferList `protobuf:"bytes,1,rep,name=token_transfers,json=tokenTransfers,proto3" json:"token_transfers,omitempty"`
...
func (x *TokenAirdropTransactionBody) GetTokenTransfers() []*common.TokenTransferList {
	if x != nil {
...
var file_token_airdrop_proto_goTypes = []any{
	...
	(*common.TokenTransferList)(nil),    // 1: proto.TokenTransferList
}
