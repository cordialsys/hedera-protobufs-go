...
type TransactionBody struct {
	...
	BatchKey *common.Key `protobuf:"bytes,73,opt,name=batch_key,json=batchKey,proto3" json:"batch_key,omitempty"`
...
func (x *TransactionBody) GetBatchKey() *common.Key {
	if x != nil {
		return x.BatchKey
	}
	return nil
...
func (x *TransactionBody) GetStateSignatureTransaction() *event.StateSignatureTransaction {
	if x != nil {
...
func (x *TransactionBody) GetHintsPreprocessingVote() *hints.HintsPreprocessingVoteTransactionBody {
	if x != nil {
...
func (x *TransactionBody) GetHintsKeyPublication() *hints.HintsKeyPublicationTransactionBody {
	if x != nil {
...
func (x *TransactionBody) GetHintsPartialSignature() *hints.HintsPartialSignatureTransactionBody {
	if x != nil {
...
func (x *TransactionBody) GetHistoryProofSignature() *history.HistoryProofSignatureTransactionBody {
	if x != nil {
...
func (x *TransactionBody) GetHistoryProofKeyPublication() *history.HistoryProofKeyPublicationTransactionBody {
	if x != nil {
...
func (x *TransactionBody) GetHistoryProofVote() *history.HistoryProofVoteTransactionBody {
	if x != nil {
...
func (x *TransactionBody) GetCrsPublication() *hints.CrsPublicationTransactionBody {
	if x != nil {
...
type TransactionBody_StateSignatureTransaction struct {
	...
	StateSignatureTransaction *event.StateSignatureTransaction `protobuf:"bytes,65,opt,name=state_signature_transaction,json=stateSignatureTransaction,proto3,oneof"`
}

type TransactionBody_HintsPreprocessingVote struct {
	// *
	// A transaction body for voting on hinTS aggregation keys.
	HintsPreprocessingVote *hints.HintsPreprocessingVoteTransactionBody `protobuf:"bytes,66,opt,name=hints_preprocessing_vote,json=hintsPreprocessingVote,proto3,oneof"`
}

type TransactionBody_HintsKeyPublication struct {
	// *
	// A transaction body for publishing a node's hintTS key.
	HintsKeyPublication *hints.HintsKeyPublicationTransactionBody `protobuf:"bytes,67,opt,name=hints_key_publication,json=hintsKeyPublication,proto3,oneof"`
}
...
type TransactionBody_HintsPartialSignature struct {
	...
	HintsPartialSignature *hints.HintsPartialSignatureTransactionBody `protobuf:"bytes,68,opt,name=hints_partial_signature,json=hintsPartialSignature,proto3,oneof"`
}
...
type TransactionBody_HistoryProofSignature struct {
	...
	HistoryProofSignature *history.HistoryProofSignatureTransactionBody `protobuf:"bytes,69,opt,name=history_proof_signature,json=historyProofSignature,proto3,oneof"`
}

type TransactionBody_HistoryProofKeyPublication struct {
	// *
	// A transaction body for publishing a node's metadata proof key.
	HistoryProofKeyPublication *history.HistoryProofKeyPublicationTransactionBody `protobuf:"bytes,70,opt,name=history_proof_key_publication,json=historyProofKeyPublication,proto3,oneof"`
}
...
type TransactionBody_HistoryProofVote struct {
	...
	HistoryProofVote *history.HistoryProofVoteTransactionBody `protobuf:"bytes,71,opt,name=history_proof_vote,json=historyProofVote,proto3,oneof"`
}

type TransactionBody_CrsPublication struct {
	// *
	// A transaction body for broadcasting a node's crs publication
	CrsPublication *hints.CrsPublicationTransactionBody `protobuf:"bytes,72,opt,name=crs_publication,json=crsPublication,proto3,oneof"`
}
...
var file_transaction_proto_goTypes = []any{
	...
	(*common.SignatureList)(nil),                              // 3: proto.SignatureList
	(*common.SignatureMap)(nil),                               // 4: proto.SignatureMap
	(*common.TransactionID)(nil),                              // 5: proto.TransactionID
	(*common.AccountID)(nil),                                  // 6: proto.AccountID
	(*Duration)(nil),                                          // 7: proto.Duration
	(*common.Key)(nil),                                        // 8: proto.Key
	...
	(*event.StateSignatureTransaction)(nil),                   // 62: com.hedera.hapi.platform.event.StateSignatureTransaction
	(*hints.HintsPreprocessingVoteTransactionBody)(nil),       // 63: com.hedera.hapi.services.auxiliary.hints.HintsPreprocessingVoteTransactionBody
	(*hints.HintsKeyPublicationTransactionBody)(nil),          // 64: com.hedera.hapi.services.auxiliary.hints.HintsKeyPublicationTransactionBody
	(*hints.HintsPartialSignatureTransactionBody)(nil),        // 65: com.hedera.hapi.services.auxiliary.hints.HintsPartialSignatureTransactionBody
	(*history.HistoryProofSignatureTransactionBody)(nil),      // 66: com.hedera.hapi.services.auxiliary.history.HistoryProofSignatureTransactionBody
	(*history.HistoryProofKeyPublicationTransactionBody)(nil), // 67: com.hedera.hapi.services.auxiliary.history.HistoryProofKeyPublicationTransactionBody
	(*history.HistoryProofVoteTransactionBody)(nil),           // 68: com.hedera.hapi.services.auxiliary.history.HistoryProofVoteTransactionBody
	(*hints.CrsPublicationTransactionBody)(nil),               // 69: com.hedera.hapi.services.auxiliary.hints.CrsPublicationTransactionBody
