...
type TransactionReceipt struct {
	...
	TopicID *common.TopicID `protobuf:"bytes,6,opt,name=topicID,proto3" json:"topicID,omitempty"`
	// *
	...
	TokenID *common.TokenID `protobuf:"bytes,10,opt,name=tokenID,proto3" json:"tokenID,omitempty"`
	// *
	...
	ScheduleID *common.ScheduleID `protobuf:"bytes,12,opt,name=scheduleID,proto3" json:"scheduleID,omitempty"`
	// *
	...
	ScheduledTransactionID *common.TransactionID `protobuf:"bytes,13,opt,name=scheduledTransactionID,proto3" json:"scheduledTransactionID,omitempty"`
	// *
...
func (x *TransactionReceipt) GetAccountID() *common.AccountID {
	if x != nil {
		return x.AccountID
	}
	return nil
...
func (x *TransactionReceipt) GetFileID() *common.FileID {
	if x != nil {
		return x.FileID
	}
	return nil
...
func (x *TransactionReceipt) GetContractID() *common.ContractID {
	if x != nil {
		return x.ContractID
	}
	return nil
...
func (x *TransactionReceipt) GetTopicID() *common.TopicID {
	if x != nil {
		return x.TopicID
	}
	return nil
...
func (x *TransactionReceipt) GetTokenID() *common.TokenID {
	if x != nil {
		return x.TokenID
	}
	return nil
...
func (x *TransactionReceipt) GetScheduleID() *common.ScheduleID {
	if x != nil {
		return x.ScheduleID
	}
	return nil
...
func (x *TransactionReceipt) GetScheduledTransactionID() *common.TransactionID {
	if x != nil {
...
var file_transaction_receipt_proto_goTypes = []any{
	...
	(*common.FileID)(nil),        // 3: proto.FileID
	(*common.ContractID)(nil),    // 4: proto.ContractID
	(*ExchangeRateSet)(nil),      // 5: proto.ExchangeRateSet
	(*common.TopicID)(nil),       // 6: proto.TopicID
	(*common.TokenID)(nil),       // 7: proto.TokenID
	(*common.ScheduleID)(nil),    // 8: proto.ScheduleID
	(*common.TransactionID)(nil), // 9: proto.TransactionID
}
