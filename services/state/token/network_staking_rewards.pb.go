...
type NetworkStakingRewards struct {
	...
	LastNodeRewardPaymentsTime *common.Timestamp `protobuf:"bytes,5,opt,name=last_node_reward_payments_time,json=lastNodeRewardPaymentsTime,proto3" json:"last_node_reward_payments_time,omitempty"`
...
func (x *NetworkStakingRewards) GetLastNodeRewardPaymentsTime() *common.Timestamp {
	if x != nil {
...
const file_state_token_network_staking_rewards_proto_rawDesc = "" +
	"\n" +
	")state/token/network_staking_rewards.proto\x12\x05proto\x1a\x0ftimestamp.proto\"\xbb\x02\n" +
