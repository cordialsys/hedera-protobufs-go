...
type BlockStreamInfo struct {
	...
	// the current block.
	BlockEndTime *common.Timestamp `protobuf:"bytes,9,opt,name=block_end_time,json=blockEndTime,proto3" json:"block_end_time,omitempty"`
	// *
	...
	CreationSoftwareVersion *common.SemanticVersion `protobuf:"bytes,11,opt,name=creation_software_version,json=creationSoftwareVersion,proto3" json:"creation_software_version,omitempty"`
	// *
	...
	LastIntervalProcessTime *common.Timestamp `protobuf:"bytes,12,opt,name=last_interval_process_time,json=lastIntervalProcessTime,proto3" json:"last_interval_process_time,omitempty"`
	// *
	// The time stamp at which the last user transaction was handled.
	// <p>
	// This field SHALL hold the consensus time for the last time
	// at which a user transaction was handled.
	LastHandleTime *common.Timestamp `protobuf:"bytes,13,opt,name=last_handle_time,json=lastHandleTime,proto3" json:"last_handle_time,omitempty"`
...
func (x *BlockStreamInfo) GetBlockEndTime() *common.Timestamp {
	if x != nil {
...
func (x *BlockStreamInfo) GetCreationSoftwareVersion() *common.SemanticVersion {
	if x != nil {
...
func (x *BlockStreamInfo) GetLastIntervalProcessTime() *common.Timestamp {
	if x != nil {
...
func (x *BlockStreamInfo) GetLastHandleTime() *common.Timestamp {
	if x != nil {
...
const file_state_blockstream_block_stream_info_proto_rawDesc = "" +
	"\n" +
	")state/blockstream/block_stream_info.proto\x12&com.hedera.hapi.node.state.blockstream\x1a\x0ftimestamp.proto\x1a\x11basic_types.proto\"\x97\x06\n" +
	...
	"\x19start_of_block_state_hash\x18\x06 \x01(\fR\x15startOfBlockStateHash\x12;\n" +
	"\x1anum_preceding_output_items\x18\a \x01(\rR\x17numPrecedingOutputItems\x12R\n" +
	"&rightmost_preceding_output_tree_hashes\x18\b \x03(\fR\"rightmostPrecedingOutputTreeHashes\x126\n" +
...
var file_state_blockstream_block_stream_info_proto_goTypes = []any{
	...
	(*common.SemanticVersion)(nil), // 2: proto.SemanticVersion
}
