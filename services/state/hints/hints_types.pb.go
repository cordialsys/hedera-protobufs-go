...
func (CRSStage) Descriptor() protoreflect.EnumDescriptor {
	return file_state_hints_hints_types_proto_enumTypes[0].Descriptor()
}

func (CRSStage) Type() protoreflect.EnumType {
	return &file_state_hints_hints_types_proto_enumTypes[0]
}
...
func (CRSStage) EnumDescriptor() ([]byte, []int) {
	return file_state_hints_hints_types_proto_rawDescGZIP(), []int{0}
}
...
func (x *HintsPartyId) Reset() {
	*x = HintsPartyId{}
	mi := &file_state_hints_hints_types_proto_msgTypes[0]
...
type HintsKeySet struct {
	...
	AdoptionTime *common.Timestamp `protobuf:"bytes,2,opt,name=adoption_time,json=adoptionTime,proto3" json:"adoption_time,omitempty"`
	// *
...
func (x *HintsKeySet) Reset() {
	*x = HintsKeySet{}
	mi := &file_state_hints_hints_types_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HintsKeySet) Descriptor() ([]byte, []int) {
	return file_state_hints_hints_types_proto_rawDescGZIP(), []int{1}
}
...
func (x *HintsKeySet) GetAdoptionTime() *common.Timestamp {
	if x != nil {
...
func (x *PreprocessedKeys) Reset() {
	*x = PreprocessedKeys{}
	mi := &file_state_hints_hints_types_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PreprocessedKeys) Descriptor() ([]byte, []int) {
	return file_state_hints_hints_types_proto_rawDescGZIP(), []int{2}
}
...
func (x *PreprocessingVoteId) Reset() {
	*x = PreprocessingVoteId{}
	mi := &file_state_hints_hints_types_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PreprocessingVoteId) Descriptor() ([]byte, []int) {
	return file_state_hints_hints_types_proto_rawDescGZIP(), []int{3}
}
...
func (x *PreprocessingVote) Reset() {
	*x = PreprocessingVote{}
	mi := &file_state_hints_hints_types_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PreprocessingVote) Descriptor() ([]byte, []int) {
	return file_state_hints_hints_types_proto_rawDescGZIP(), []int{4}
}
...
func (x *NodePartyId) Reset() {
	*x = NodePartyId{}
	mi := &file_state_hints_hints_types_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NodePartyId) Descriptor() ([]byte, []int) {
	return file_state_hints_hints_types_proto_rawDescGZIP(), []int{5}
}
...
func (x *HintsScheme) Reset() {
	*x = HintsScheme{}
	mi := &file_state_hints_hints_types_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HintsScheme) Descriptor() ([]byte, []int) {
	return file_state_hints_hints_types_proto_rawDescGZIP(), []int{6}
}
...
func (x *HintsConstruction) Reset() {
	*x = HintsConstruction{}
	mi := &file_state_hints_hints_types_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HintsConstruction) Descriptor() ([]byte, []int) {
	return file_state_hints_hints_types_proto_rawDescGZIP(), []int{7}
}
...
func (x *HintsConstruction) GetGracePeriodEndTime() *common.Timestamp {
	if x != nil {
...
func (x *HintsConstruction) GetPreprocessingStartTime() *common.Timestamp {
	if x != nil {
...
type HintsConstruction_GracePeriodEndTime struct {
	...
	GracePeriodEndTime *common.Timestamp `protobuf:"bytes,4,opt,name=grace_period_end_time,json=gracePeriodEndTime,proto3,oneof"`
}
...
type HintsConstruction_PreprocessingStartTime struct {
	...
	PreprocessingStartTime *common.Timestamp `protobuf:"bytes,5,opt,name=preprocessing_start_time,json=preprocessingStartTime,proto3,oneof"`
}
...
type CRSState struct {
	...
	ContributionEndTime *common.Timestamp `protobuf:"bytes,4,opt,name=contribution_end_time,json=contributionEndTime,proto3" json:"contribution_end_time,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *CRSState) Reset() {
	*x = CRSState{}
	mi := &file_state_hints_hints_types_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CRSState) Descriptor() ([]byte, []int) {
	return file_state_hints_hints_types_proto_rawDescGZIP(), []int{8}
}
...
func (x *CRSState) GetContributionEndTime() *common.Timestamp {
	if x != nil {
...
var File_state_hints_hints_types_proto protoreflect.FileDescriptor

const file_state_hints_hints_types_proto_rawDesc = "" +
	"\n" +
	"\x1dstate/hints/hints_types.proto\x12 com.hedera.hapi.node.state.hints\x1a\x0ftimestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"J\n" +
	...
	"\bparty_id\x18\x02 \x01(\rR\apartyId\"\xc3\x01\n" +
	"\vHintsScheme\x12_\n" +
...
var (
	...
	file_state_hints_hints_types_proto_rawDescData []byte
)

func file_state_hints_hints_types_proto_rawDescGZIP() []byte {
	file_state_hints_hints_types_proto_rawDescOnce.Do(func() {
		file_state_hints_hints_types_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_state_hints_hints_types_proto_rawDesc), len(file_state_hints_hints_types_proto_rawDesc)))
	})
	return file_state_hints_hints_types_proto_rawDescData
}

var file_state_hints_hints_types_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_state_hints_hints_types_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_state_hints_hints_types_proto_goTypes = []any{
...
var file_state_hints_hints_types_proto_depIdxs = []int32{
...
func init() { file_state_hints_hints_types_proto_init() }
func file_state_hints_hints_types_proto_init() {
	if File_state_hints_hints_types_proto != nil {
		return
	}
	file_state_hints_hints_types_proto_msgTypes[4].OneofWrappers = []any{
		(*PreprocessingVote_PreprocessedKeys)(nil),
		(*PreprocessingVote_CongruentNodeId)(nil),
	}
	file_state_hints_hints_types_proto_msgTypes[7].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_state_hints_hints_types_proto_rawDesc), len(file_state_hints_hints_types_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_state_hints_hints_types_proto_goTypes,
		DependencyIndexes: file_state_hints_hints_types_proto_depIdxs,
		EnumInfos:         file_state_hints_hints_types_proto_enumTypes,
		MessageInfos:      file_state_hints_hints_types_proto_msgTypes,
	}.Build()
	File_state_hints_hints_types_proto = out.File
	file_state_hints_hints_types_proto_goTypes = nil
	file_state_hints_hints_types_proto_depIdxs = nil
}
