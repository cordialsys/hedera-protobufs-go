...
type BlockInfo struct {
	...
	FirstConsTimeOfLastBlock *common.Timestamp `protobuf:"bytes,2,opt,name=first_cons_time_of_last_block,json=firstConsTimeOfLastBlock,proto3" json:"first_cons_time_of_last_block,omitempty"`
	// *
	...
	ConsTimeOfLastHandledTxn *common.Timestamp `protobuf:"bytes,4,opt,name=cons_time_of_last_handled_txn,json=consTimeOfLastHandledTxn,proto3" json:"cons_time_of_last_handled_txn,omitempty"`
	// *
	...
	// is finished.
	FirstConsTimeOfCurrentBlock *common.Timestamp `protobuf:"bytes,6,opt,name=first_cons_time_of_current_block,json=firstConsTimeOfCurrentBlock,proto3" json:"first_cons_time_of_current_block,omitempty"`
...
func (x *BlockInfo) Reset() {
	*x = BlockInfo{}
	mi := &file_state_blockrecords_block_info_proto_msgTypes[0]
...
func (*BlockInfo) Descriptor() ([]byte, []int) {
	return file_state_blockrecords_block_info_proto_rawDescGZIP(), []int{0}
}
...
func (x *BlockInfo) GetFirstConsTimeOfLastBlock() *common.Timestamp {
	if x != nil {
...
func (x *BlockInfo) GetConsTimeOfLastHandledTxn() *common.Timestamp {
	if x != nil {
...
func (x *BlockInfo) GetFirstConsTimeOfCurrentBlock() *common.Timestamp {
	if x != nil {
...
var File_state_blockrecords_block_info_proto protoreflect.FileDescriptor

const file_state_blockrecords_block_info_proto_rawDesc = "" +
	"\n" +
	"#state/blockrecords/block_info.proto\x12\x05proto\x1a\x0ftimestamp.proto\"\x97\x03\n" +
	"\tBlockInfo\x12*\n" +
...
var (
	...
	file_state_blockrecords_block_info_proto_rawDescData []byte
)

func file_state_blockrecords_block_info_proto_rawDescGZIP() []byte {
	file_state_blockrecords_block_info_proto_rawDescOnce.Do(func() {
		file_state_blockrecords_block_info_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_state_blockrecords_block_info_proto_rawDesc), len(file_state_blockrecords_block_info_proto_rawDesc)))
	})
	return file_state_blockrecords_block_info_proto_rawDescData
}

var file_state_blockrecords_block_info_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_state_blockrecords_block_info_proto_goTypes = []any{
	(*BlockInfo)(nil),        // 0: proto.BlockInfo
	(*common.Timestamp)(nil), // 1: proto.Timestamp
}
var file_state_blockrecords_block_info_proto_depIdxs = []int32{
...
func init() { file_state_blockrecords_block_info_proto_init() }
func file_state_blockrecords_block_info_proto_init() {
	if File_state_blockrecords_block_info_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_state_blockrecords_block_info_proto_rawDesc), len(file_state_blockrecords_block_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_state_blockrecords_block_info_proto_goTypes,
		DependencyIndexes: file_state_blockrecords_block_info_proto_depIdxs,
		MessageInfos:      file_state_blockrecords_block_info_proto_msgTypes,
	}.Build()
	File_state_blockrecords_block_info_proto = out.File
	file_state_blockrecords_block_info_proto_goTypes = nil
	file_state_blockrecords_block_info_proto_depIdxs = nil
}
