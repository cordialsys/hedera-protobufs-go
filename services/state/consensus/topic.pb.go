...
type Topic struct {
	...
	FeeScheduleKey *common.Key `protobuf:"bytes,11,opt,name=fee_schedule_key,json=feeScheduleKey,proto3" json:"fee_schedule_key,omitempty"`
	// *
	...
	FeeExemptKeyList []*common.Key `protobuf:"bytes,12,rep,name=fee_exempt_key_list,json=feeExemptKeyList,proto3" json:"fee_exempt_key_list,omitempty"`
	// *
	...
	CustomFees    []*services.FixedCustomFee `protobuf:"bytes,13,rep,name=custom_fees,json=customFees,proto3" json:"custom_fees,omitempty"`
...
func (x *Topic) GetFeeScheduleKey() *common.Key {
	if x != nil {
...
func (x *Topic) GetFeeExemptKeyList() []*common.Key {
	if x != nil {
...
func (x *Topic) GetCustomFees() []*services.FixedCustomFee {
	if x != nil {
		return x.CustomFees
	}
	return nil
...
const file_state_consensus_topic_proto_rawDesc = "" +
	"\n" +
	"\x1bstate/consensus/topic.proto\x12\x05proto\x1a\x11basic_types.proto\x1a\x11custom_fees.proto\"\xc7\x04\n" +
	"\x05Topic\x12)\n" +
	...
	"submit_key\x18\n" +
	" \x01(\v2\n" +
	".proto.KeyR\tsubmitKey\x124\n" +
	"\x10fee_schedule_key\x18\v \x01(\v2\n" +
	".proto.KeyR\x0efeeScheduleKey\x129\n" +
...
var file_state_consensus_topic_proto_goTypes = []any{
	...
	(*services.FixedCustomFee)(nil), // 4: proto.FixedCustomFee
}
