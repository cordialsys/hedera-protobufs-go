...
type ScheduleIdList struct {
	...
	// <p>
	// While the order is not _specified_, it MUST be deterministic.
	ScheduleIds   []*common.ScheduleID `protobuf:"bytes,1,rep,name=schedule_ids,json=scheduleIds,proto3" json:"schedule_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ScheduleIdList) Reset() {
	*x = ScheduleIdList{}
	mi := &file_state_schedule_schedule_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ScheduleIdList) Descriptor() ([]byte, []int) {
	return file_state_schedule_schedule_proto_rawDescGZIP(), []int{2}
}

func (x *ScheduleIdList) GetScheduleIds() []*common.ScheduleID {
	if x != nil {
...
func (x *ScheduledCounts) Reset() {
	*x = ScheduledCounts{}
	mi := &file_state_schedule_schedule_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ScheduledCounts) Descriptor() ([]byte, []int) {
	return file_state_schedule_schedule_proto_rawDescGZIP(), []int{3}
}
...
func (x *ScheduledOrder) Reset() {
	*x = ScheduledOrder{}
	mi := &file_state_schedule_schedule_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ScheduledOrder) Descriptor() ([]byte, []int) {
	return file_state_schedule_schedule_proto_rawDescGZIP(), []int{4}
}
...
const file_state_schedule_schedule_proto_rawDesc = "" +
	"\n" +
	"\x1dstate/schedule/schedule.proto\x12\x05proto\x1a\x11basic_types.proto\x1a\x0ftimestamp.proto\x1a\"schedulable_transaction_body.proto\x1a\x11transaction.proto\"\xb6\x06\n" +
	"\bSchedule\x122\n" +
	...
	"\fScheduleList\x12-\n" +
	"\tschedules\x18\x01 \x03(\v2\x0f.proto.ScheduleR\tschedules\"F\n" +
	"\x0eScheduleIdList\x124\n" +
	"\fschedule_ids\x18\x01 \x03(\v2\x11.proto.ScheduleIDR\vscheduleIds\"g\n" +
	"\x0fScheduledCounts\x12)\n" +
	"\x10number_scheduled\x18\x01 \x01(\rR\x0fnumberScheduled\x12)\n" +
...
var file_state_schedule_schedule_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_state_schedule_schedule_proto_goTypes = []any{
	...
	(*common.ScheduleID)(nil),                   // 5: proto.ScheduleID
	(*common.AccountID)(nil),                    // 6: proto.AccountID
	(*common.Key)(nil),                          // 7: proto.Key
	(*common.Timestamp)(nil),                    // 8: proto.Timestamp
	(*services.SchedulableTransactionBody)(nil), // 9: proto.SchedulableTransactionBody
	(*services.TransactionBody)(nil),            // 10: proto.TransactionBody
}
