...
func (x *LedgerId) Reset() {
	*x = LedgerId{}
	mi := &file_state_roster_ledger_id_proto_msgTypes[0]
...
func (*LedgerId) Descriptor() ([]byte, []int) {
	return file_state_roster_ledger_id_proto_rawDescGZIP(), []int{0}
}
...
func (x *RosterSignatures) Reset() {
	*x = RosterSignatures{}
	mi := &file_state_roster_ledger_id_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RosterSignatures) Descriptor() ([]byte, []int) {
	return file_state_roster_ledger_id_proto_rawDescGZIP(), []int{1}
}
...
func (x *NodeSignature) Reset() {
	*x = NodeSignature{}
	mi := &file_state_roster_ledger_id_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NodeSignature) Descriptor() ([]byte, []int) {
	return file_state_roster_ledger_id_proto_rawDescGZIP(), []int{2}
}
...
var File_state_roster_ledger_id_proto protoreflect.FileDescriptor

const file_state_roster_ledger_id_proto_rawDesc = "" +
	"\n" +
	"\x1cstate/roster/ledger_id.proto\x12!com.hedera.hapi.node.state.roster\"\xca\x01\n" +
	"\bLedgerId\x12\x1b\n" +
...
var (
	...
	file_state_roster_ledger_id_proto_rawDescData []byte
)

func file_state_roster_ledger_id_proto_rawDescGZIP() []byte {
	file_state_roster_ledger_id_proto_rawDescOnce.Do(func() {
		file_state_roster_ledger_id_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_state_roster_ledger_id_proto_rawDesc), len(file_state_roster_ledger_id_proto_rawDesc)))
	})
	return file_state_roster_ledger_id_proto_rawDescData
}

var file_state_roster_ledger_id_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_state_roster_ledger_id_proto_goTypes = []any{
...
var file_state_roster_ledger_id_proto_depIdxs = []int32{
...
func init() { file_state_roster_ledger_id_proto_init() }
func file_state_roster_ledger_id_proto_init() {
	if File_state_roster_ledger_id_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_state_roster_ledger_id_proto_rawDesc), len(file_state_roster_ledger_id_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_state_roster_ledger_id_proto_goTypes,
		DependencyIndexes: file_state_roster_ledger_id_proto_depIdxs,
		MessageInfos:      file_state_roster_ledger_id_proto_msgTypes,
	}.Build()
	File_state_roster_ledger_id_proto = out.File
	file_state_roster_ledger_id_proto_goTypes = nil
	file_state_roster_ledger_id_proto_depIdxs = nil
}
