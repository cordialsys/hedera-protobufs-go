...
type ConsensusCreateTopicTransactionBody struct {
	...
	FeeScheduleKey *common.Key `protobuf:"bytes,8,opt,name=fee_schedule_key,json=feeScheduleKey,proto3" json:"fee_schedule_key,omitempty"`
	// *
	// A set of keys.<br/>
	...
	FeeExemptKeyList []*common.Key `protobuf:"bytes,9,rep,name=fee_exempt_key_list,json=feeExemptKeyList,proto3" json:"fee_exempt_key_list,omitempty"`
	// *
...
func (x *ConsensusCreateTopicTransactionBody) GetFeeScheduleKey() *common.Key {
	if x != nil {
...
func (x *ConsensusCreateTopicTransactionBody) GetFeeExemptKeyList() []*common.Key {
	if x != nil {
...
const file_consensus_create_topic_proto_rawDesc = "" +
	"\n" +
	"\x1cconsensus_create_topic.proto\x12\x05proto\x1a\x11basic_types.proto\x1a\x11custom_fees.proto\x1a\x0eduration.proto\"\xad\x03\n" +
	...
	"\x10autoRenewAccount\x18\a \x01(\v2\x10.proto.AccountIDR\x10autoRenewAccount\x124\n" +
	"\x10fee_schedule_key\x18\b \x01(\v2\n" +
	".proto.KeyR\x0efeeScheduleKey\x129\n" +
	"\x13fee_exempt_key_list\x18\t \x03(\v2\n" +
	".proto.KeyR\x10feeExemptKeyList\x126\n" +
	"\vcustom_fees\x18\n" +
	" \x03(\v2\x15.proto.FixedCustomFeeR\n" +
	"customFeesBZ\n" +
