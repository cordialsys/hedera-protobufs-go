...
type TokenCancelAirdropTransactionBody struct {
	...
	PendingAirdrops []*common.PendingAirdropId `protobuf:"bytes,1,rep,name=pending_airdrops,json=pendingAirdrops,proto3" json:"pending_airdrops,omitempty"`
...
func (x *TokenCancelAirdropTransactionBody) GetPendingAirdrops() []*common.PendingAirdropId {
	if x != nil {
...
const file_token_cancel_airdrop_proto_rawDesc = "" +
	"\n" +
	"\x1atoken_cancel_airdrop.proto\x12\x05proto\x1a\x11basic_types.proto\"g\n" +
	"!TokenCancelAirdropTransactionBody\x12B\n" +
	"\x10pending_airdrops\x18\x01 \x03(\v2\x17.proto.PendingAirdropIdR\x0fpendingAirdropsBZ\n" +
...
var (
	...
	file_token_cancel_airdrop_proto_rawDescData []byte
)

func file_token_cancel_airdrop_proto_rawDescGZIP() []byte {
	file_token_cancel_airdrop_proto_rawDescOnce.Do(func() {
		file_token_cancel_airdrop_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_token_cancel_airdrop_proto_rawDesc), len(file_token_cancel_airdrop_proto_rawDesc)))
	})
...
var file_token_cancel_airdrop_proto_goTypes = []any{
	...
	(*common.PendingAirdropId)(nil),           // 1: proto.PendingAirdropId
}
...
func file_token_cancel_airdrop_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_token_cancel_airdrop_proto_rawDesc), len(file_token_cancel_airdrop_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
