...
const file_basic_types_proto_rawDesc = "" +
	...
	"\brealmNum\x18\x02 \x01(\x03R\brealmNum\"\x88\x01\n" +
	"\tAccountID\x12\x1a\n" +
	"\bshardNum\x18\x01 \x01(\x03R\bshardNum\x12\x1a\n" +
	...
	"\vdenominator\x18\x02 \x01(\x03R\vdenominator\"]\n" +
	"\aTopicID\x12\x1a\n" +
	"\bshardNum\x18\x01 \x01(\x03R\bshardNum\x12\x1a\n" +
	"\brealmNum\x18\x02 \x01(\x03R\brealmNum\x12\x1a\n" +
	"\btopicNum\x18\x03 \x01(\x03R\btopicNum\"]\n" +
	"\aTokenID\x12\x1a\n" +
	"\bshardNum\x18\x01 \x01(\x03R\bshardNum\x12\x1a\n" +
	"\brealmNum\x18\x02 \x01(\x03R\brealmNum\x12\x1a\n" +
	"\btokenNum\x18\x03 \x01(\x03R\btokenNum\"f\n" +
	"\n" +
	"ScheduleID\x12\x1a\n" +
	"\bshardNum\x18\x01 \x01(\x03R\bshardNum\x12\x1a\n" +
	"\brealmNum\x18\x02 \x01(\x03R\brealmNum\x12 \n" +
	"\vscheduleNum\x18\x03 \x01(\x03R\vscheduleNum\"\xf8\x02\n" +
	"\x03Key\x123\n" +
	"\n" +
	...
	"\tECDSA_384\x18\x04 \x01(\fH\x00R\bECDSA384\x129\n" +
	...
	"\rSignatureList\x12$\n" +
	"\x04sigs\x18\x02 \x03(\v2\x10.proto.SignatureR\x04sigs:\x02\x18\x01\"\xe1\x01\n" +
	"\rSignaturePair\x12\"\n" +
	"\fpubKeyPrefix\x18\x01 \x01(\fR\fpubKeyPrefix\x12\x1c\n" +
	"\bcontract\x18\x02 \x01(\fH\x00R\bcontract\x12\x1a\n" +
	"\aed25519\x18\x03 \x01(\fH\x00R\aed25519\x12\x1b\n" +
	"\bRSA_3072\x18\x04 \x01(\fH\x00R\aRSA3072\x12\x1d\n" +
	"\tECDSA_384\x18\x05 \x01(\fH\x00R\bECDSA384\x12)\n" +
	...
	"\bUnpaused\x10\x02*\x81\x0e\n" +
	"\x13HederaFunctionality\x12\b\n" +
	"\x04NONE\x10\x00\x12\x12\n" +
	"\x0eCryptoTransfer\x10\x01\x12\x10\n" +
	"\fCryptoUpdate\x10\x02\x12\x10\n" +
	"\fCryptoDelete\x10\x03\x12\x15\n" +
	"\x11CryptoAddLiveHash\x10\x04\x12\x18\n" +
	"\x14CryptoDeleteLiveHash\x10\x05\x12\x10\n" +
	...
	"\bGetByKey\x10\x14\x12\x15\n" +
	"\x11CryptoGetLiveHash\x10\x15\x12\x14\n" +
	...
	"\x12ContractGetRecords\x10\x1a\x12\x10\n" +
