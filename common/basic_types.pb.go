...
func (x *AccountID) GetAccountNum() int64 {
	if x != nil {
		if x, ok := x.Account.(*AccountID_AccountNum); ok {
			return x.AccountNum
		}
	}
	return 0
...
func (x *AccountID) GetAlias() []byte {
	if x != nil {
		if x, ok := x.Account.(*AccountID_Alias); ok {
			return x.Alias
		}
	}
	return nil
...
func (x *ContractID) GetContractNum() int64 {
	if x != nil {
		if x, ok := x.Contract.(*ContractID_ContractNum); ok {
...
func (x *ContractID) GetEvmAddress() []byte {
	if x != nil {
		if x, ok := x.Contract.(*ContractID_EvmAddress); ok {
			return x.EvmAddress
		}
	}
	return nil
...
func (x *Key) GetContractID() *ContractID {
	if x != nil {
		if x, ok := x.Key.(*Key_ContractID); ok {
			return x.ContractID
		}
	}
	return nil
...
func (x *Key) GetECDSA_384() []byte {
	if x != nil {
		if x, ok := x.Key.(*Key_ECDSA_384); ok {
			return x.ECDSA_384
		}
	}
	return nil
...
func (x *Key) GetThresholdKey() *ThresholdKey {
	if x != nil {
		if x, ok := x.Key.(*Key_ThresholdKey); ok {
...
func (x *Key) GetECDSASecp256K1() []byte {
	if x != nil {
		if x, ok := x.Key.(*Key_ECDSASecp256K1); ok {
...
func (x *Key) GetDelegatableContractId() *ContractID {
	if x != nil {
		if x, ok := x.Key.(*Key_DelegatableContractId); ok {
...
func (x *Signature) GetContract() []byte {
	if x != nil {
		if x, ok := x.Signature.(*Signature_Contract); ok {
			return x.Contract
		}
	}
	return nil
...
func (x *Signature) GetRSA_3072() []byte {
	if x != nil {
		if x, ok := x.Signature.(*Signature_RSA_3072); ok {
			return x.RSA_3072
		}
	}
	return nil
...
func (x *Signature) GetECDSA_384() []byte {
	if x != nil {
		if x, ok := x.Signature.(*Signature_ECDSA_384); ok {
			return x.ECDSA_384
		}
	}
	return nil
...
func (x *Signature) GetThresholdSignature() *ThresholdSignature {
	if x != nil {
		if x, ok := x.Signature.(*Signature_ThresholdSignature); ok {
...
func (x *Signature) GetSignatureList() *SignatureList {
	if x != nil {
		if x, ok := x.Signature.(*Signature_SignatureList); ok {
...
func (x *SignaturePair) GetContract() []byte {
	if x != nil {
		if x, ok := x.Signature.(*SignaturePair_Contract); ok {
			return x.Contract
		}
	}
	return nil
...
func (x *SignaturePair) GetEd25519() []byte {
	if x != nil {
		if x, ok := x.Signature.(*SignaturePair_Ed25519); ok {
			return x.Ed25519
		}
	}
	return nil
...
func (x *SignaturePair) GetRSA_3072() []byte {
	if x != nil {
		if x, ok := x.Signature.(*SignaturePair_RSA_3072); ok {
			return x.RSA_3072
		}
	}
	return nil
...
func (x *SignaturePair) GetECDSA_384() []byte {
	if x != nil {
		if x, ok := x.Signature.(*SignaturePair_ECDSA_384); ok {
			return x.ECDSA_384
		}
	}
	return nil
...
func (x *SignaturePair) GetECDSASecp256K1() []byte {
	if x != nil {
		if x, ok := x.Signature.(*SignaturePair_ECDSASecp256K1); ok {
			return x.ECDSASecp256K1
		}
	}
	return nil
...
func (x *StakingInfo) GetStakedAccountId() *AccountID {
	if x != nil {
		if x, ok := x.StakedId.(*StakingInfo_StakedAccountId); ok {
...
func (x *StakingInfo) GetStakedNodeId() int64 {
	if x != nil {
		if x, ok := x.StakedId.(*StakingInfo_StakedNodeId); ok {
...
type PendingAirdropId struct {
	...
	// Types that are valid to be assigned to TokenReference:
	//
...
func (x *PendingAirdropId) GetTokenReference() isPendingAirdropId_TokenReference {
	if x != nil {
...
func (x *PendingAirdropId) GetFungibleTokenType() *TokenID {
	if x != nil {
		if x, ok := x.TokenReference.(*PendingAirdropId_FungibleTokenType); ok {
...
func (x *PendingAirdropId) GetNonFungibleToken() *NftID {
	if x != nil {
		if x, ok := x.TokenReference.(*PendingAirdropId_NonFungibleToken); ok {
...
const file_basic_types_proto_rawDesc = "" +
	"\n" +
	"\x11basic_types.proto\x12\x05proto\x1a\x0ftimestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"%\n" +
	"\aShardID\x12\x1a\n" +
	"\bshardNum\x18\x01 \x01(\x03R\bshardNum\"A\n" +
	"\aRealmID\x12\x1a\n" +
	"\bshardNum\x18\x01 \x01(\x03R\bshardNum\x12\x1a\n" +
	"\brealmNum\x18\x02 \x01(\x03R\brealmNum\"]\n" +
	"\aTokenID\x12\x1a\n" +
	"\bshardNum\x18\x01 \x01(\x03R\bshardNum\x12\x1a\n" +
	"\brealmNum\x18\x02 \x01(\x03R\brealmNum\x12\x1a\n" +
	"\btokenNum\x18\x03 \x01(\x03R\btokenNum\"\x88\x01\n" +
	"\tAccountID\x12\x1a\n" +
	"\bshardNum\x18\x01 \x01(\x03R\bshardNum\x12\x1a\n" +
	"\brealmNum\x18\x02 \x01(\x03R\brealmNum\x12 \n" +
	"\n" +
	"accountNum\x18\x03 \x01(\x03H\x00R\n" +
	"accountNum\x12\x16\n" +
	"\x05alias\x18\x04 \x01(\fH\x00R\x05aliasB\t\n" +
	"\aaccount\"W\n" +
	"\x05NftID\x12)\n" +
	"\btoken_ID\x18\x01 \x01(\v2\x0e.proto.TokenIDR\atokenID\x12#\n" +
	"\rserial_number\x18\x02 \x01(\x03R\fserialNumber\"Z\n" +
	"\x06FileID\x12\x1a\n" +
	"\bshardNum\x18\x01 \x01(\x03R\bshardNum\x12\x1a\n" +
	"\brealmNum\x18\x02 \x01(\x03R\brealmNum\x12\x18\n" +
	"\afileNum\x18\x03 \x01(\x03R\afileNum\"\x97\x01\n" +
	"\n" +
	"ContractID\x12\x1a\n" +
	"\bshardNum\x18\x01 \x01(\x03R\bshardNum\x12\x1a\n" +
	"\brealmNum\x18\x02 \x01(\x03R\brealmNum\x12\"\n" +
	"\vcontractNum\x18\x03 \x01(\x03H\x00R\vcontractNum\x12!\n" +
	"\vevm_address\x18\x04 \x01(\fH\x00R\n" +
	"evmAddressB\n" +
	"\n" +
	"\bcontract\"]\n" +
	"\aTopicID\x12\x1a\n" +
	"\bshardNum\x18\x01 \x01(\x03R\bshardNum\x12\x1a\n" +
	"\brealmNum\x18\x02 \x01(\x03R\brealmNum\x12\x1a\n" +
	"\btopicNum\x18\x03 \x01(\x03R\btopicNum\"f\n" +
	"\n" +
	"ScheduleID\x12\x1a\n" +
	"\bshardNum\x18\x01 \x01(\x03R\bshardNum\x12\x1a\n" +
	"\brealmNum\x18\x02 \x01(\x03R\brealmNum\x12 \n" +
	"\vscheduleNum\x18\x03 \x01(\x03R\vscheduleNum\"\xbb\x01\n" +
	"\rTransactionID\x12F\n" +
	"\x15transactionValidStart\x18\x01 \x01(\v2\x10.proto.TimestampR\x15transactionValidStart\x12.\n" +
	"\taccountID\x18\x02 \x01(\v2\x10.proto.AccountIDR\taccountID\x12\x1c\n" +
	"\tscheduled\x18\x03 \x01(\bR\tscheduled\x12\x14\n" +
	"\x05nonce\x18\x04 \x01(\x05R\x05nonce\"x\n" +
	"\rAccountAmount\x12.\n" +
	"\taccountID\x18\x01 \x01(\v2\x10.proto.AccountIDR\taccountID\x12\x16\n" +
	"\x06amount\x18\x02 \x01(\x12R\x06amount\x12\x1f\n" +
	"\vis_approval\x18\x03 \x01(\bR\n" +
	"isApproval\"L\n" +
	"\fTransferList\x12<\n" +
	"\x0eaccountAmounts\x18\x01 \x03(\v2\x14.proto.AccountAmountR\x0eaccountAmounts\"\xce\x01\n" +
	"\vNftTransfer\x12:\n" +
	"\x0fsenderAccountID\x18\x01 \x01(\v2\x10.proto.AccountIDR\x0fsenderAccountID\x12>\n" +
	"\x11receiverAccountID\x18\x02 \x01(\v2\x10.proto.AccountIDR\x11receiverAccountID\x12\"\n" +
	"\fserialNumber\x18\x03 \x01(\x03R\fserialNumber\x12\x1f\n" +
	"\vis_approval\x18\x04 \x01(\bR\n" +
	"isApproval\"\xf0\x01\n" +
	"\x11TokenTransferList\x12$\n" +
	"\x05token\x18\x01 \x01(\v2\x0e.proto.TokenIDR\x05token\x122\n" +
	"\ttransfers\x18\x02 \x03(\v2\x14.proto.AccountAmountR\ttransfers\x126\n" +
	"\fnftTransfers\x18\x03 \x03(\v2\x12.proto.NftTransferR\fnftTransfers\x12I\n" +
	"\x11expected_decimals\x18\x04 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x10expectedDecimals\"J\n" +
	"\bFraction\x12\x1c\n" +
	"\tnumerator\x18\x01 \x01(\x03R\tnumerator\x12 \n" +
	"\vdenominator\x18\x02 \x01(\x03R\vdenominator\"\x80\x03\n" +
	"\x03Key\x123\n" +
	"\n" +
	"contractID\x18\x01 \x01(\v2\x11.proto.ContractIDH\x00R\n" +
	"contractID\x12\x1a\n" +
	"\aed25519\x18\x02 \x01(\fH\x00R\aed25519\x12\x1f\n" +
	"\bRSA_3072\x18\x03 \x01(\fB\x02\x18\x01H\x00R\aRSA3072\x12!\n" +
	"\tECDSA_384\x18\x04 \x01(\fB\x02\x18\x01H\x00R\bECDSA384\x129\n" +
	"\fthresholdKey\x18\x05 \x01(\v2\x13.proto.ThresholdKeyH\x00R\fthresholdKey\x12*\n" +
	"\akeyList\x18\x06 \x01(\v2\x0e.proto.KeyListH\x00R\akeyList\x12)\n" +
	"\x0fECDSA_secp256k1\x18\a \x01(\fH\x00R\x0eECDSASecp256k1\x12K\n" +
	"\x17delegatable_contract_id\x18\b \x01(\v2\x11.proto.ContractIDH\x00R\x15delegatableContractIdB\x05\n" +
	"\x03key\"P\n" +
	"\fThresholdKey\x12\x1c\n" +
	"\tthreshold\x18\x01 \x01(\rR\tthreshold\x12\"\n" +
	"\x04keys\x18\x02 \x01(\v2\x0e.proto.KeyListR\x04keys\")\n" +
	"\aKeyList\x12\x1e\n" +
	"\x04keys\x18\x01 \x03(\v2\n" +
	".proto.KeyR\x04keys\"\x9d\x02\n" +
	"\tSignature\x12\x1c\n" +
	"\bcontract\x18\x01 \x01(\fH\x00R\bcontract\x12\x1a\n" +
	"\aed25519\x18\x02 \x01(\fH\x00R\aed25519\x12\x1b\n" +
	"\bRSA_3072\x18\x03 \x01(\fH\x00R\aRSA3072\x12\x1d\n" +
	"\tECDSA_384\x18\x04 \x01(\fH\x00R\bECDSA384\x12K\n" +
	"\x12thresholdSignature\x18\x05 \x01(\v2\x19.proto.ThresholdSignatureH\x00R\x12thresholdSignature\x12<\n" +
	"\rsignatureList\x18\x06 \x01(\v2\x14.proto.SignatureListH\x00R\rsignatureList:\x02\x18\x01B\v\n" +
	"\tsignature\"B\n" +
	"\x12ThresholdSignature\x12(\n" +
	"\x04sigs\x18\x02 \x01(\v2\x14.proto.SignatureListR\x04sigs:\x02\x18\x01\"9\n" +
	"\rSignatureList\x12$\n" +
	"\x04sigs\x18\x02 \x03(\v2\x10.proto.SignatureR\x04sigs:\x02\x18\x01\"\xe9\x01\n" +
	"\rSignaturePair\x12\"\n" +
	"\fpubKeyPrefix\x18\x01 \x01(\fR\fpubKeyPrefix\x12\x1c\n" +
	"\bcontract\x18\x02 \x01(\fH\x00R\bcontract\x12\x1a\n" +
	"\aed25519\x18\x03 \x01(\fH\x00R\aed25519\x12\x1f\n" +
	"\bRSA_3072\x18\x04 \x01(\fB\x02\x18\x01H\x00R\aRSA3072\x12!\n" +
	"\tECDSA_384\x18\x05 \x01(\fB\x02\x18\x01H\x00R\bECDSA384\x12)\n" +
	"\x0fECDSA_secp256k1\x18\x06 \x01(\fH\x00R\x0eECDSASecp256k1B\v\n" +
	"\tsignature\">\n" +
	"\fSignatureMap\x12.\n" +
	"\asigPair\x18\x01 \x03(\v2\x14.proto.SignaturePairR\asigPair\"\xdf\x01\n" +
	"\rFeeComponents\x12\x10\n" +
	"\x03min\x18\x01 \x01(\x03R\x03min\x12\x10\n" +
	"\x03max\x18\x02 \x01(\x03R\x03max\x12\x1a\n" +
	"\bconstant\x18\x03 \x01(\x03R\bconstant\x12\x10\n" +
	"\x03bpt\x18\x04 \x01(\x03R\x03bpt\x12\x10\n" +
	"\x03vpt\x18\x05 \x01(\x03R\x03vpt\x12\x10\n" +
	"\x03rbh\x18\x06 \x01(\x03R\x03rbh\x12\x10\n" +
	"\x03sbh\x18\a \x01(\x03R\x03sbh\x12\x10\n" +
	"\x03gas\x18\b \x01(\x03R\x03gas\x12\x0e\n" +
	"\x02tv\x18\t \x01(\x03R\x02tv\x12\x10\n" +
	"\x03bpr\x18\n" +
	" \x01(\x03R\x03bpr\x12\x12\n" +
	"\x04sbpr\x18\v \x01(\x03R\x04sbpr\"\xb8\x01\n" +
	"\x16TransactionFeeSchedule\x12L\n" +
	"\x13hederaFunctionality\x18\x01 \x01(\x0e2\x1a.proto.HederaFunctionalityR\x13hederaFunctionality\x12,\n" +
	"\afeeData\x18\x02 \x01(\v2\x0e.proto.FeeDataB\x02\x18\x01R\afeeData\x12\"\n" +
	"\x04fees\x18\x03 \x03(\v2\x0e.proto.FeeDataR\x04fees\"\xd5\x01\n" +
	"\aFeeData\x120\n" +
	"\bnodedata\x18\x01 \x01(\v2\x14.proto.FeeComponentsR\bnodedata\x126\n" +
	"\vnetworkdata\x18\x02 \x01(\v2\x14.proto.FeeComponentsR\vnetworkdata\x126\n" +
	"\vservicedata\x18\x03 \x01(\v2\x14.proto.FeeComponentsR\vservicedata\x12(\n" +
	"\asubType\x18\x04 \x01(\x0e2\x0e.proto.SubTypeR\asubType\"\x9d\x01\n" +
	"\vFeeSchedule\x12U\n" +
	"\x16transactionFeeSchedule\x18\x01 \x03(\v2\x1d.proto.TransactionFeeScheduleR\x16transactionFeeSchedule\x127\n" +
	"\n" +
	"expiryTime\x18\x02 \x01(\v2\x17.proto.TimestampSecondsR\n" +
	"expiryTime\"\x9d\x01\n" +
	"\x19CurrentAndNextFeeSchedule\x12B\n" +
	"\x12currentFeeSchedule\x18\x01 \x01(\v2\x12.proto.FeeScheduleR\x12currentFeeSchedule\x12<\n" +
	"\x0fnextFeeSchedule\x18\x02 \x01(\v2\x12.proto.FeeScheduleR\x0fnextFeeSchedule\"h\n" +
	"\x0fServiceEndpoint\x12 \n" +
	"\vipAddressV4\x18\x01 \x01(\fR\vipAddressV4\x12\x12\n" +
	"\x04port\x18\x02 \x01(\x05R\x04port\x12\x1f\n" +
	"\vdomain_name\x18\x03 \x01(\tR\n" +
	"domainName\"\xf4\x02\n" +
	"\vNodeAddress\x12 \n" +
	"\tipAddress\x18\x01 \x01(\fB\x02\x18\x01R\tipAddress\x12\x1a\n" +
	"\x06portno\x18\x02 \x01(\x05B\x02\x18\x01R\x06portno\x12\x16\n" +
	"\x04memo\x18\x03 \x01(\fB\x02\x18\x01R\x04memo\x12\x1d\n" +
	"\n" +
	"RSA_PubKey\x18\x04 \x01(\tR\tRSAPubKey\x12\x16\n" +
	"\x06nodeId\x18\x05 \x01(\x03R\x06nodeId\x126\n" +
	"\rnodeAccountId\x18\x06 \x01(\v2\x10.proto.AccountIDR\rnodeAccountId\x12\"\n" +
	"\fnodeCertHash\x18\a \x01(\fR\fnodeCertHash\x12@\n" +
	"\x0fserviceEndpoint\x18\b \x03(\v2\x16.proto.ServiceEndpointR\x0fserviceEndpoint\x12 \n" +
	"\vdescription\x18\t \x01(\tR\vdescription\x12\x18\n" +
	"\x05stake\x18\n" +
	" \x01(\x03B\x02\x18\x01R\x05stake\"G\n" +
	"\x0fNodeAddressBook\x124\n" +
	"\vnodeAddress\x18\x01 \x03(\v2\x12.proto.NodeAddressR\vnodeAddress\"{\n" +
	"\x0fSemanticVersion\x12\x14\n" +
	"\x05major\x18\x01 \x01(\x05R\x05major\x12\x14\n" +
	"\x05minor\x18\x02 \x01(\x05R\x05minor\x12\x14\n" +
	"\x05patch\x18\x03 \x01(\x05R\x05patch\x12\x10\n" +
	"\x03pre\x18\x04 \x01(\tR\x03pre\x12\x14\n" +
	"\x05build\x18\x05 \x01(\tR\x05build\"G\n" +
	"\aSetting\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\x12\x12\n" +
	"\x04data\x18\x03 \x01(\fR\x04data\"I\n" +
	"\x19ServicesConfigurationList\x12,\n" +
	"\tnameValue\x18\x01 \x03(\v2\x0e.proto.SettingR\tnameValue\"\xb3\x02\n" +
	"\x11TokenRelationship\x12(\n" +
	"\atokenId\x18\x01 \x01(\v2\x0e.proto.TokenIDR\atokenId\x12\x16\n" +
	"\x06symbol\x18\x02 \x01(\tR\x06symbol\x12\x18\n" +
	"\abalance\x18\x03 \x01(\x04R\abalance\x123\n" +
	"\tkycStatus\x18\x04 \x01(\x0e2\x15.proto.TokenKycStatusR\tkycStatus\x12<\n" +
	"\ffreezeStatus\x18\x05 \x01(\x0e2\x18.proto.TokenFreezeStatusR\ffreezeStatus\x12\x1a\n" +
	"\bdecimals\x18\x06 \x01(\rR\bdecimals\x123\n" +
	"\x15automatic_association\x18\a \x01(\bR\x14automaticAssociation\"n\n" +
	"\fTokenBalance\x12(\n" +
	"\atokenId\x18\x01 \x01(\v2\x0e.proto.TokenIDR\atokenId\x12\x18\n" +
	"\abalance\x18\x02 \x01(\x04R\abalance\x12\x1a\n" +
	"\bdecimals\x18\x03 \x01(\rR\bdecimals\"J\n" +
	"\rTokenBalances\x129\n" +
	"\rtokenBalances\x18\x01 \x03(\v2\x13.proto.TokenBalanceR\rtokenBalances\"n\n" +
	"\x10TokenAssociation\x12)\n" +
	"\btoken_id\x18\x01 \x01(\v2\x0e.proto.TokenIDR\atokenId\x12/\n" +
	"\n" +
	"account_id\x18\x02 \x01(\v2\x10.proto.AccountIDR\taccountId\"\xb2\x02\n" +
	"\vStakingInfo\x12%\n" +
	"\x0edecline_reward\x18\x01 \x01(\bR\rdeclineReward\x12>\n" +
	"\x12stake_period_start\x18\x02 \x01(\v2\x10.proto.TimestampR\x10stakePeriodStart\x12%\n" +
	"\x0epending_reward\x18\x03 \x01(\x03R\rpendingReward\x12 \n" +
	"\fstaked_to_me\x18\x04 \x01(\x03R\n" +
	"stakedToMe\x12>\n" +
	"\x11staked_account_id\x18\x05 \x01(\v2\x10.proto.AccountIDH\x00R\x0fstakedAccountId\x12&\n" +
	"\x0estaked_node_id\x18\x06 \x01(\x03H\x00R\fstakedNodeIdB\v\n" +
	"\tstaked_id\"\x87\x02\n" +
	"\x10PendingAirdropId\x12-\n" +
	"\tsender_id\x18\x01 \x01(\v2\x10.proto.AccountIDR\bsenderId\x121\n" +
	"\vreceiver_id\x18\x02 \x01(\v2\x10.proto.AccountIDR\n" +
	"receiverId\x12@\n" +
	"\x13fungible_token_type\x18\x03 \x01(\v2\x0e.proto.TokenIDH\x00R\x11fungibleTokenType\x12<\n" +
	"\x12non_fungible_token\x18\x04 \x01(\v2\f.proto.NftIDH\x00R\x10nonFungibleTokenB\x11\n" +
	"\x0ftoken_reference\"-\n" +
	"\x13PendingAirdropValue\x12\x16\n" +
	"\x06amount\x18\x01 \x01(\x04R\x06amount*\"\n" +
	"\x12BlockHashAlgorithm\x12\f\n" +
	"\bSHA2_384\x10\x00*9\n" +
	"\tTokenType\x12\x13\n" +
	"\x0fFUNGIBLE_COMMON\x10\x00\x12\x17\n" +
	...
	"\x1fSUBMIT_MESSAGE_WITH_CUSTOM_FEES\x10\a*+\n" +
	"\x0fTokenSupplyType\x12\f\n" +
	"\bINFINITE\x10\x00\x12\n" +
	"\n" +
	"\x06FINITE\x10\x01*<\n" +
	"\x12TokenKeyValidation\x12\x13\n" +
	"\x0fFULL_VALIDATION\x10\x00\x12\x11\n" +
	"\rNO_VALIDATION\x10\x01*F\n" +
	"\x11TokenFreezeStatus\x12\x17\n" +
	"\x13FreezeNotApplicable\x10\x00\x12\n" +
	"\n" +
	"\x06Frozen\x10\x01\x12\f\n" +
	"\bUnfrozen\x10\x02*@\n" +
	"\x0eTokenKycStatus\x12\x14\n" +
	"\x10KycNotApplicable\x10\x00\x12\v\n" +
	...
	"\bUnpaused\x10\x02*\x8d\x10\n" +
	"\x13HederaFunctionality\x12\b\n" +
	"\x04NONE\x10\x00\x12\x12\n" +
	"\x0eCryptoTransfer\x10\x01\x12\x10\n" +
	"\fCryptoUpdate\x10\x02\x12\x10\n" +
	"\fCryptoDelete\x10\x03\x12\x19\n" +
	"\x11CryptoAddLiveHash\x10\x04\x1a\x02\b\x01\x12\x1c\n" +
	"\x14CryptoDeleteLiveHash\x10\x05\x1a\x02\b\x01\x12\x10\n" +
	"\fContractCall\x10\x06\x12\x12\n" +
	"\x0eContractCreate\x10\a\x12\x12\n" +
	"\x0eContractUpdate\x10\b\x12\x0e\n" +
	"\n" +
	...
	"\x12\x0e\n" +
	"\n" +
	"FileUpdate\x10\v\x12\x0e\n" +
	"\n" +
	"FileDelete\x10\f\x12\x1b\n" +
	...
	"\x0fContractGetInfo\x10\x11\x12\x17\n" +
	"\x13ContractGetBytecode\x10\x12\x12\x13\n" +
	"\x0fGetBySolidityID\x10\x13\x12\f\n" +
	"\bGetByKey\x10\x14\x12\x19\n" +
	"\x11CryptoGetLiveHash\x10\x15\x1a\x02\b\x01\x12\x18\n" +
	"\x10CryptoGetStakers\x10\x16\x1a\x02\b\x01\x12\x13\n" +
	"\x0fFileGetContents\x10\x17\x12\x0f\n" +
	"\vFileGetInfo\x10\x18\x12\x18\n" +
	"\x14TransactionGetRecord\x10\x19\x12\x1a\n" +
	"\x12ContractGetRecords\x10\x1a\x1a\x02\b\x01\x12\x10\n" +
	"\fCryptoCreate\x10\x1b\x12\x10\n" +
	"\fSystemDelete\x10\x1c\x12\x12\n" +
	"\x0eSystemUndelete\x10\x1d\x12\x12\n" +
	"\x0eContractDelete\x10\x1e\x12\n" +
	"\n" +
	"\x06Freeze\x10\x1f\x12\x1b\n" +
	"\x17CreateTransactionRecord\x10 \x12\x1a\n" +
	"\x16CryptoAccountAutoRenew\x10!\x12\x15\n" +
	"\x11ContractAutoRenew\x10\"\x12\x12\n" +
	"\x0eGetVersionInfo\x10#\x12\x19\n" +
	"\x15TransactionGetReceipt\x10$\x12\x18\n" +
	"\x14ConsensusCreateTopic\x102\x12\x18\n" +
	"\x14ConsensusUpdateTopic\x103\x12\x18\n" +
	"\x14ConsensusDeleteTopic\x104\x12\x19\n" +
	"\x15ConsensusGetTopicInfo\x105\x12\x1a\n" +
	"\x16ConsensusSubmitMessage\x106\x12\x13\n" +
	"\x0fUncheckedSubmit\x107\x12\x0f\n" +
	"\vTokenCreate\x108\x12\x10\n" +
	"\fTokenGetInfo\x10:\x12\x16\n" +
	...
	"\vTokenDelete\x10?\x12\x0f\n" +
	"\vTokenUpdate\x10@\x12\r\n" +
	"\tTokenMint\x10A\x12\r\n" +
	"\tTokenBurn\x10B\x12\x14\n" +
	"\x10TokenAccountWipe\x10C\x12\x1b\n" +
	"\x17TokenAssociateToAccount\x10D\x12\x1e\n" +
	"\x1aTokenDissociateFromAccount\x10E\x12\x12\n" +
	"\x0eScheduleCreate\x10F\x12\x12\n" +
	"\x0eScheduleDelete\x10G\x12\x10\n" +
	"\fScheduleSign\x10H\x12\x13\n" +
	"\x0fScheduleGetInfo\x10I\x12\x1f\n" +
	"\x17TokenGetAccountNftInfos\x10J\x1a\x02\b\x01\x12\x17\n" +
	"\x0fTokenGetNftInfo\x10K\x1a\x02\b\x01\x12\x14\n" +
	"\x10TokenGetNftInfos\x10L\x12\x1a\n" +
	"\x16TokenFeeScheduleUpdate\x10M\x12\x1f\n" +
	"\x17NetworkGetExecutionTime\x10N\x1a\x02\b\x01\x12\x0e\n" +
	"\n" +
	"TokenPause\x10O\x12\x10\n" +
	"\fTokenUnpause\x10P\x12\x1a\n" +
	"\x16CryptoApproveAllowance\x10Q\x12\x19\n" +
	"\x15CryptoDeleteAllowance\x10R\x12\x15\n" +
	"\x11GetAccountDetails\x10S\x12\x17\n" +
	"\x13EthereumTransaction\x10T\x12\x13\n" +
	"\x0fNodeStakeUpdate\x10U\x12\f\n" +
	"\bUtilPrng\x10V\x12 \n" +
	"\x18TransactionGetFastRecord\x10W\x1a\x02\b\x01\x12\x13\n" +
	...
	"\vTokenReject\x10\\\x12\x10\n" +
	"\fTokenAirdrop\x10]\x12\x16\n" +
	"\x12TokenCancelAirdrop\x10^\x12\x15\n" +
	"\x11TokenClaimAirdrop\x10_\x12\x1d\n" +
	"\x19StateSignatureTransaction\x10d\x12\x17\n" +
	"\x13HintsKeyPublication\x10e\x12\x1a\n" +
	"\x16HintsPreprocessingVote\x10f\x12\x19\n" +
...
var (
	...
	file_basic_types_proto_rawDescData []byte
)

func file_basic_types_proto_rawDescGZIP() []byte {
	file_basic_types_proto_rawDescOnce.Do(func() {
		file_basic_types_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_basic_types_proto_rawDesc), len(file_basic_types_proto_rawDesc)))
	})
...
func file_basic_types_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_basic_types_proto_rawDesc), len(file_basic_types_proto_rawDesc)),
			NumEnums:      9,
			NumMessages:   41,
			NumExtensions: 0,
			NumServices:   0,
